            ...
            <div class="flex items-center justify-between">
                ...
                <div class="hidden md:block">
                    <div class="text-right">
                        ...
                        <div class="text-white font-semibold"><?php echo htmlspecialchars($_SESSION['username'] ?? 'Administrator'); ?></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            <nav class="flex space-x-8">
                <a href="/admin" class="text-white bg-purple-600 px-4 py-2 rounded-lg font-medium">Dashboard</a>
