...
try {
    ...
    error_log("Database error in order.php: " . $e->getMessage());
    $vpsPackages = [];
}
        ...
        <form method="POST" class="space-y-8">
            ...
            <div class="bg-gray-800 rounded-xl p-8 border border-gray-700">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <label class="relative cursor-pointer">
                        <input type="radio" name="package_id" value="2" class="sr-only peer">
                        <div class="border-2 border-gray-600 peer-checked:border-purple-500 rounded-lg p-6 hover:border-gray-500 transition-colors bg-gray-700">
                            <h3 class="text-lg font-semibold text-white">VPS Professional</h3>
                            <p class="text-gray-300 text-sm mt-1">Für anspruchsvolle Projekte</p>
                            <div class="mt-4">
                                <span class="text-2xl font-bold text-white">€19,99</span>
                                <span class="text-gray-300">/Monat</span>
                            </div>
                            <ul class="mt-4 space-y-2 text-sm text-gray-300">
                                <li><i class="fas fa-check text-green-400 mr-2"></i>4 GB RAM</li>
                                <li><i class="fas fa-check text-green-400 mr-2"></i>4 vCPU Cores</li>
                                <li><i class="fas fa-check text-green-400 mr-2"></i>50 GB SSD</li>
                            </ul>
                        </div>
                    </label>
                    
                    <label class="relative cursor-pointer">
                        <input type="radio" name="package_id" value="3" class="sr-only peer">
                        <div class="border-2 border-gray-600 peer-checked:border-purple-500 rounded-lg p-6 hover:border-gray-500 transition-colors bg-gray-700">
                            <h3 class="text-lg font-semibold text-white">VPS Enterprise</h3>
                            <p class="text-gray-300 text-sm mt-1">Maximale Performance</p>
                            <div class="mt-4">
                                <span class="text-2xl font-bold text-white">€39,99</span>
                                <span class="text-gray-300">/Monat</span>
                            </div>
                            <ul class="mt-4 space-y-2 text-sm text-gray-300">
                                <li><i class="fas fa-check text-green-400 mr-2"></i>8 GB RAM</li>
                                <li><i class="fas fa-check text-green-400 mr-2"></i>6 vCPU Cores</li>
                                <li><i class="fas fa-check text-green-400 mr-2"></i>100 GB SSD</li>
                            </ul>
                        </div>
                    </label>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <label class="relative cursor-pointer">
                        <input type="radio" name="package_id" value="<?php echo $package['id']; ?>" class="sr-only peer" <?php echo empty($vpsPackages) ? '' : 'required'; ?>>
                        <div class="border-2 border-gray-600 peer-checked:border-purple-500 rounded-lg p-6 hover:border-gray-500 transition-colors bg-gray-700">
